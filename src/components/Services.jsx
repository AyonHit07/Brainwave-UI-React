      ...
      <div className="container">
        ...
        <div className="relative">
          <div className="relative flex items-center z-1 h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            ...
            <Generating className="absolute border left-4 right-4 bottom-4 border-n-1/10 lg:left-1/2 lg-right-auto lg:button-8 lg:-translate-x-1/2" />
          </div>
          ...
          <div className="relative grid gap-5 z-1 lg:grid-cols-2">
            ...
            <div
              className="p-4
            overflow-hidden bg-n-7 rounded-3xl lg:min-h-[46rem]"
            >
                    ...
                    <li
                      className={`flex items-center justify-center ${
                        index === 2
                          ...
                          : "flex w-10 h-10 bg-n-6 md:w-15 md:h-15 rounded-2xl "
                      }`}
                      key={index}
                    >
              ...
              <div className="relative h-[20rem] bg-n-8 rounded-xl overflow-hidden md:h-[25rem]">
                <img className="object-cover w-full h-full" width={520} height={400} src={service3} alt="Scary Robot" />
                <VideoChatMessage/>
                <VideoBar/>
              </div>
            </div>
